var terms = '''END USER LICENSE AGREEMENT

Last updated September 09, 2022



ئیروان ساکا irwan saka is licensed to You (End-User) by دامەزراوەی گوند Institute De Ville , located and registered at Irwan, Mergasor, Erbil, Erbil, Erbil 11000, Iraq ("Licensor"), for use only under the terms of this License Agreement.
...
The parties of this License Agreement acknowledge that the Services are not a Party to this License Agreement and are not bound by any provisions or obligations with regard to the Licensed Application, such as warranty, liability, maintenance and support thereof. دامەزراوەی گوند Institute De Ville , not the Services, is solely responsible for the Licensed Application and the content thereof.

This License Agreement may not provide for usage rules for the Licensed Application that are in conflict with the latest Google Play Terms of Service ("Usage Rules"). دامەزراوەی گوند Institute De Ville acknowledges that it had the opportunity to review the Usage Rules and this License Agreement is not conflicting with them.

ئیروان ساکا irwan saka when purchased or downloaded through the Services, is licensed to You for use only under the terms of this License Agreement. The Licensor reserves all rights not expressly granted to You. ئیروان ساکا irwan saka is to be used on devices that operate with Google's operating system ("Android").
...
ئیروان ساکا irwan saka ("Licensed Application") is a piece of software created to make teaching and/or learning more available through technology. And act as an identity for the school. — and customized for Android mobile devices ("Devices"). It is used to read books and learn through educational sources..
...
2.3  You may not reverse engineer, translate, disassemble, integrate, decompile, remove, modify, combine, create derivative works or updates of, adapt, or attempt to derive the source code of the Licensed Application, or any part thereof (except with دامەزراوەی گوند Institute De Ville 's prior written consent).
...
4.2  دامەزراوەی گوند Institute De Ville  and the End-User acknowledge that the Services have no obligation whatsoever to furnish any maintenance and support services with respect to the Licensed Application.
...
8.2  No warranty is provided for the Licensed Application that is not executable on the device, that has been unauthorizedly modified, handled inappropriately or culpably, combined or installed with inappropriate hardware or software, used with inappropriate accessories, regardless if by Yourself or by third parties, or if there are any other reasons outside of دامەزراوەی گوند Institute De Ville 's sphere of influence that affect the executability of the Licensed Application.

8.3  You are required to inspect the Licensed Application immediately after installing it and notify دامەزراوەی گوند Institute De Ville about issues discovered without delay by email provided in Product Claims. The defect report will be taken into consideration and further investigated if it has been emailed within a period of thirty (30) days after discovery.

8.4  If we confirm that the Licensed Application is defective, دامەزراوەی گوند Institute De Ville reserves a choice to remedy the situation either by means of solving the defect or substitute delivery.
...
دامەزراوەی گوند Institute De Ville  and the End-User acknowledge that دامەزراوەی گوند Institute De Ville , and not the Services, is responsible for addressing any claims of the End-User or any third party relating to the Licensed Application or the End-User’s possession and/or use of that Licensed Application, including, but not limited to:
...
Irwan Saka School
Irwan, Mergasor, Erbil
Erbil, Erbil 11000
Iraq
irwansakaSchool@gmail.com


12. TERMINATION

The license is valid until terminated by دامەزراوەی گوند Institute De Ville or by You. Your rights under this license will terminate automatically and without notice from دامەزراوەی گوند Institute De Ville if You fail to adhere to any term(s) of this license. Upon License termination, You shall stop all use of the Licensed Application, and destroy all copies, full or partial, of the Licensed Application.
      

13. THIRD-PARTY TERMS OF AGREEMENTS AND BENEFICIARY

دامەزراوەی گوند Institute De Ville represents and warrants that دامەزراوەی گوند Institute De Ville will comply with applicable third-party terms of agreement when using Licensed Application.
...
دامەزراوەی گوند Institute De Ville and the End-User acknowledge that, in the event of any third-party claim that the Licensed Application or the End-User's possession and use of that Licensed Application infringes on the third party's intellectual property rights, دامەزراوەی گوند Institute De Ville , and not the Services, will be solely responsible for the investigation, defense, settlement, and discharge or any such intellectual property infringement claims.
...
16.3  ئەم بەرنامەیە دروستکراوە بۆ بواری پەروەردە و فێربوون دروستکراوە.
''';
var privacy = '''PRIVACY NOTICE
...
Want to learn more about what دامەزراوەی گوند Institute De Ville does with any information we collect? Click here to review the notice in full.
...
Our app does not and will not collect any data regardless of the data type being private or even app-related.

Sensitive Information. We do not process sensitive information.

2. HOW DO WE PROCESS YOUR INFORMATION?

In short as mentioned before since no data collection takes places in our app there won't be any data processing as well.
...
We value our users privacy and do not and will not collect any sort of data.

4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?

In Short: NO, we do not use cookies or any other tracking technologies within our app.

5. HOW DO WE HANDLE YOUR SOCIAL LOGINS?

In Short: Our app does not have any login buttons or any login-functioning technology built-into it.

6. IS YOUR INFORMATION TRANSFERRED INTERNATIONALLY?

In Short: No data is collected to be transfered.

7. HOW LONG DO WE KEEP YOUR INFORMATION?

In Short: We do not use and have not built any data storing technologies in our app.
...
In Short: Users have the right to use the app responsibly and can delete, reccommend, share, the app with other users.
...
If you have questions or comments about this notice, you may email us at institutedeville@gmail.com.

13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?

Regardless of the applicable laws of your country, our app does not collect any private or, for that matter, even app-related data like (crashes, analytics... etc.).
''';
